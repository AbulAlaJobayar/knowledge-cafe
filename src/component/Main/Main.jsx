...
const Main = ({ data,handleAddToBookMark,handleAddtoTitle }) => {
    const { name, title, img, authorImg, date, readTime,id } = data
    return (
        <div className='rounded-lg border mb-28 p-7 '>
            ...
            <div className='flex justify-between mt-8 items-center'>
                ...
                <p className='text-lg'>{readTime} min read <FontAwesomeIcon onClick={()=>handleAddtoTitle(title,id)} className='cursor-pointer' icon={faBookmark} /></p>
            </div>
