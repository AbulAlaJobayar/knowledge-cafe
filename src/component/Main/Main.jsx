...
const Main = ({ data,handleAddToBookMark,handleaddTitle }) => {
    ...
    return (
        <div className='rounded-lg border mb-28 p-7 '>
            ...
            <div className='flex justify-between mt-8 items-center'>
                ...
                <p className='text-lg'>{readTime} min read <FontAwesomeIcon onClick={()=>handleaddTitle(data)} className='cursor-pointer' icon={faBookmark} /></p>
            </div>
